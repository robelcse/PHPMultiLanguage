...
if((isset($_GET['language']) && $_GET['language']=='en') || !isset($_GET['language'])){
	$en_select='selected';	
	$language='en';
}elseif(((isset($_GET['language']) && $_GET['language']=='bn'))) {
	$bn_select='selected';	
	$language='bn';
} else{
	$hi_select='selected';
	...
	<head>
		...
		<body>
					...
					<ul>
						...
						<li class="fright">
							...
							<select onchange="set_language()" name="language" id="language">
								...
								<option value="bn" <?php echo $bn_select?>>BN</option>
			...
			function set_language(){
				...
				window.location.href='http://localhost/PHPMultiLanguage/?language='+language;
			}
			</script>
		</body>
	</head>
